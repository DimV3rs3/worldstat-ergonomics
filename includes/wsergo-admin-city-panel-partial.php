<?php
/**
 * Панель «Эргономичность города» (подключается из WSErgo_Admin::render_settings_page).
 *
			...
			<div id="wsergo-panel-city" class="wsergo-scope-panel" style="display:none;">
				...
				<form class="wsergo-settings-form" method="post" action="options.php">
					...
					<div id="city-tab-data" class="wsergo-city-tab-panel" style="display:none;">
						...
						<p class="description"><?php esc_html_e( 'Индекс города собирается по городским метрикам, нормализации показателей и активной формуле E.', 'worldstat-ergonomics' ); ?></p>
						<table class="form-table">
							<tr>
